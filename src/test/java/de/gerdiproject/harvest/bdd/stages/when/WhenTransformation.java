...
/**
 * A When stage with a step for the transformation of a
 * {@linkplain TimeSeriesDatasetResponse} to {@linkplain TimeSeriesDataset}
 * steps methods for the {@linkplain TimeSeriesDataset} class.
 *
 * @author Ingo Thomsen
 */
